	...
	<div class="row">
		<div class="col s12 l4 m12" >
			...
			<div class="card-panel amber">
				...
				<a href="addstudent.php"><i class="material-icons right">send</i></a>
			</div>
			<div class="card-panel amber">
			...
			<table class="responsive-table bordered">
				...
				<tbody>
					...
					while($row = mysql_fetch_array($result)){
						...
						echo "<tr><td>".$row['student_id']."</td><td>".$row['username']."</td><td>".$row['firstname']."</td><td>".$row['lastname']."</td><td>".$row['department']."</td><td>".$row['year']."</td><td>".$row['mobile']."</td><td>".$row['email']."</td></tr>";  //$row['index'] the index here is a field name
						}
					?>
				</tbody>
			</table>
